...
2. **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. **"On the Perception Bottleneck of VLMs for Chart Understanding."** arXiv, 2025. Code repository: Vision4Chart.
3. **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. **"On the Universal Truthfulness Hyperplane Inside LLMs."** EMNLP, 2024. Code repository: Universal_Truthfulness_Hyperplane.
